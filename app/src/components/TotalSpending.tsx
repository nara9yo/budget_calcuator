...
export default function TotalSpending({ total, labelPrefix = '총지출:', formatter = formatWon }: Props) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-800/90 backdrop-blur-xl border-t border-slate-200 dark:border-slate-700 py-5 px-6 shadow-2xl z-50">
      <div className="max-w-4xl mx-auto flex items-center justify-center gap-4 text-slate-800 dark:text-slate-100">
        {/* • 라벨 텍스트 표시 */}
